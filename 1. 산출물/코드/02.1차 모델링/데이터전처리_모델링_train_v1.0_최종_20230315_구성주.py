...
# 엑셀 파일로 저장
# all_reports.to_excel('classification_reports_rf.xlsx')
...
# 엑셀 파일로 저장
# all_reports.to_excel('classification_reports_xgboost.xlsx')

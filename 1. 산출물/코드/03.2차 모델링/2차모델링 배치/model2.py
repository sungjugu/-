...
with open('C:/Users/sungj/python/Batch/Data/random_forest_model.pkl', 'rb') as f:
...
# 결과 데이터프레임 만들기
result2 = pd.DataFrame({'prediction': y_pred_prob})
result2['기준년월'] = f'{yearmonth}'
result2['고객ID'] = mart['고객ID']
result2['확률'] = result2['prediction'].apply(lambda x: round(x, 2))

result2 = result2.drop('prediction', axis=1)
result2['장르'] = 'sci-fi'
result2 = result2[['기준년월', '고객ID', '장르', '확률']]
